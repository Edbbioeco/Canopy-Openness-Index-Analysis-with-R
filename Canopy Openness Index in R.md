...
-   [Canopy Openess Index in
    R](#canopy-openess-index-in-r){#toc-canopy-openess-index-in-r}
-   [Packages](#packages){#toc-packages}
-   [Data](#data){#toc-data}
    -   [Importing](#importing){#toc-importing}
    -   [Visualizing](#visualizing){#toc-visualizing}
-   [Calculating Canopy
    Openness](#calculating-canopy-openness){#toc-calculating-canopy-openness}
    -   [Visualizing](#visualizing-1){#toc-visualizing-1}
    -   [Calculating](#calculating){#toc-calculating}
